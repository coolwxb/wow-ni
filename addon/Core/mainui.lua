...
local main_ui = {};
local Localization = {
	Assistant = "Ni辅助 v0.0.60",--"Rotation Assistant",
	Support = "汉化 by zding",--"By support DarhangeR",
	Primary = "选择主脚本",--"Select primary rotation:",
	Secondary = "选择辅助脚本",--"Select secondary rotation:",
	GenericProfile = "选择通用脚本",--"Select generic rotation:",
	None = "None",
	Resource = "资源追踪开关",--"Resource Tracking Toggles",
	All = "全选",--"All",
	Reload = "修改后需重新载入",--"Reload after changing",
	Global = "开关快捷键修改",--"toggle or global",
	GUI = "主界面显示",--"GUI Toggle:",
	PrimaryKey = "主脚本开关",--"Primary Toggle:",
	SecondaryKey = "辅助脚本开关",--"Secondary Toggle:",
	Generic = "通用脚本开关",--"Generic Toggle:",
	Interrupt = "打断开关",--"Interrupt Toggle:",
	Follow = "跟随单位开关",--"Follow Unit & Toggle:",
	GlobalDev = "全局变量",--"Global variable:",
	Dev = "开发者工具",--"Dev Tools:",
	ReloadDev = "重载/rl",--"Reload",
	Console = "控制台",--"Console",
	Contact = "联系方式",--"Contact:",
	Rotation = "脚本设置",--"Rotation Settings",
	MainSettings = "主要设置",--"Main Settings",
	ResourceTrack = "资源追踪",--"Resource Track",
	CreatureTrack = "生物追踪",--"Creature Track",
	Close = "关闭",--"Close",
	Lockpicking = "撬锁",--"Lockpicking",
	Herbs = "草药",--"Herbs",
	Minerals = "矿物",--"Minerals",
	DisarmTrap = "解除陷阱",--"Disarm Trap",
	Open = "打开",--"Open",
	Treasure = "宝箱",--"Treasure",
	CloseTrack = "Close",
	ArmTrap = "Arm Trap",
	...
	Blasting = "Blasting",
	PvPOpen = "打开PVP模式",--"PvP Open",
	PvPClose = "关闭PVP模式",--"PvP Close",
	Fishing = "鱼点",--"Fishing",
	Inscription = "铭文",--"Inscription",
	OpenFromVehicle = "载具",--"Open From Vehicle",
	CreatureTrackingToggles = "生物追踪开关",--"Creature Tracking Toggles",
	Beasts = "野兽",--"Beasts",
	Dragons = "龙",--"Dragons",
	Demons = "恶魔",--"Demons",
	Elementals = "元素",--"Elementals",
	Giants = "巨人",--"Giants",
	Undead = "亡灵",--"Undead",
	Humanoids = "人型",--"Humanoids",
	Critters = "小动物",--"Critters",
	Machines = "机械",--"Machines",
	Slimes = "未分类",--"Uncategorized",
	Totem = "图腾",--"Totem",
	NonCombatPet = "非战斗宠物",--"Non Combat Pet",
	GasCloud = "气体云雾",--"Gas Cloud",
	Latency = "脚本运行延时 ("..ni.vars.latency.." 毫秒)",--"Latency ("..ni.vars.latency.." ms)",
	LatencySlider = "脚本运行延时",--"Ability Delay",
	AreaofEffectToggle = "AOE开关",--"Area of Effect Toggle:",
	PauseRotationModifier = "脚本暂停",--"Pause Rotation Modifier:",
	CDToggle = "CD开关:",
	CustomToggle = "自定义开关:",--"Custom Toggle:",
	MainTankOverride = "主坦克",--"Main Tank Override:",
	Enabled = "启用",--"Enabled:",
	OffTankOverride = "副坦克",--"Off Tank Override:",
	IsMelee = "是否近战",--"Is Melee:",
	All = "全选",--"All Classes",
	Coin = "移除小地图图标",--"Remove Icon:",
	LeftClick = "|cffC0C0C0Left 点击:|r 打开主菜单",--"|cffC0C0C0Left click:|r Open Main Menu.",
	RightClick = "|cffC0C0C0Right 点击:|r 查询更新",--"|cffC0C0C0Right click:|r Check updates.",
	MidleClick = "|cffC0C0C0Midle 点击:|r 打开Discord服务器"--"|cffC0C0C0Midle click:|r Open Discord Server."	
};
if ru then
...
local title2 = CreateText(frame, Localization.Support, 0, -25, 0.2, 0.7, 1, 0.3);
...
CreateMainButton(frame, 82, 22, Localization.Close, -68, 10, function()
	if frame:IsShown() then
		frame:Hide();
	end
end);
CreateMainButton(frame, 82, 22, "重载", 68, 10, function()
	ReloadUI();
end);
...
slider:SetScript("OnValueChanged", function(self, value)
	slider_components[latency_name.."Text"]:SetText(Localization.LatencySlider.. "("..value.." 毫秒)");	
